  ...
  return (
    <div className="space-y-3">
      <button className="border border-border rounded-lg py-3 px-20 flex justify-center items-center gap-3 w-full hover:border-secondary transition-all duration-500">
        <span className="shrink-0"><PiGoogle /></span>
        <p className="tracking-[-0.2px] font-medium whitespace-nowrap">Sign in with Google</p>
      </button>
      <button className="border border-border rounded-lg py-3 px-20 flex justify-center items-center gap-3 w-full hover:border-secondary transition-all duration-500">
        <span className="shrink-0"><PiFacebookOrginal/></span>
        <p className="tracking-[-0.2px] font-medium whitespace-nowrap">Sign in with Facebook</p>
      </button>
