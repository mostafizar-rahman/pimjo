  ...
  return (
    <div className="relative" ref={calendarRef}>
      <button
        ...
        className="max-h-11 border border-border-dash shadow-[0_1px_2px_0_rgba(16,24,40,0.05)] flex items-center gap-2 rounded-lg px-4 py-3 text-text-color-dash  transition-colors"
      >
      ...
      {showCalendar && (
        <div className="absolute sm:right-0 -right-1/2 top-12 bg-card-background-dash dark:bg-[#1A2231] p-5 rounded-md shadow-lg border border-border-dash z-50">
          <DayPicker
            mode="range"
            selected={selected}
            onSelect={setSelected}
            classNames={{
              day: `text-sm font-medium text-text-color-dash hover:bg-secondary hover:text-white rounded-md`,
              ...
              chevron: "text-text-color-dash size-5",
              caption: "text-tab-text-dash font-medium",
